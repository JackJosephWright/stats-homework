...
knitr::opts_chunk$set(eval = TRUE, results = TRUE, fig.show = "hide", message = FALSE)
set.seed(1234)
```
...
And we can visualize the distribution of these proportions with a histogram. The mean of the sampling distribution is .2, same as the data set.
